...
abstract class UserModelController extends UserResourceController {
	...
	public function store()
	{
		...
		switch (Request::format())
		{
			...
			default:
				return $success
					? Redirect::to(URL_USER . '/' . $this->alias . '/' . $item->id . '/edit')
					: Redirect::to(URL_USER . '/' . $this->alias . '/create')
	...
	public function update($itemId)
	{
		...
		switch (Request::format())
		{
			...
			default:
				$redirect = Redirect::to(URL_USER . '/' . $this->alias . '/' . $itemId . '/edit');
