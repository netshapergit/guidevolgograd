    ...
    const app = new Vue({
        ...
        methods: {
            ...
            async savePage() {
                ...
                try {
                    /*
                    const data = [...this.commonFields, ...this.additionalFields].reduce((a, b) => {
                        a[b.alias] = b.content
                        return a
                    }, {})
                    console.log(data)
                    ...
                    */
                    ...
                    await apiService.pages.update(this.page.id, data)
            ...
            async fetchPage() {
                try {
                    ...
                    let action = '/admin/pages-list/' + getLastPath(location.href)
