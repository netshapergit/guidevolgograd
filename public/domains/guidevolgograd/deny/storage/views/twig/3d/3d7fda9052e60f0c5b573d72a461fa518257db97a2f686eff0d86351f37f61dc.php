...
/* layouts.place */
class __TwigTemplate_d4a425201337c0d029b4831071c30187ef6d3348cee4bb50d1e0863c9bd82e09 extends TwigBridge\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $filters = array("escape" => 3, "json_encode" => 3, "raw" => 16, "split" => 218, "trim" => 218);
        $functions = array();
...
\t\t\t\t\t\t\t\t<div class=\"js-add-single-to-plan\" data-id=\"";
        // line 35
...
\t\t\t\t\t\t\t\t\t\t\t<button title=\"Добавить в мой маршрут\" class=\"ibtn ibtn--iconleft\" @click.stop=\"addToPlanById\">
...
\t\t\t\t\t\t\t\t\t\t</template>
\t\t\t\t\t\t\t\t\t\t<template v-else>
\t\t\t\t\t\t\t\t\t\t\t<button title=\"Удалить из моего маршрута\" class=\"ibtn ibtn--added ibtn--iconleft\" @click.stop=\"removeItemFromMyRoutePlanByID\">
\t\t\t\t\t\t\t\t\t\t\t\t<svg width=\"23\" height=\"29\" viewBox=\"0 0 23 29\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<path d=\"M14.7 23.4262C14.0401 23.6324 13.409 24.0429 12.9835 24.6747L11.5002 26.8767L10.0171 24.6749C9.59149 24.043 8.96041 23.6325 8.30039 23.4263C4.0537 22.0996 1 18.2118 1 13.6462C1 7.99621 5.68146 3.38098 11.5 3.38098C17.3185 3.38098 22 7.99621 22 13.6462C22 18.2116 18.9465 22.0993 14.7 23.4262Z\" stroke=\"#E85768\" stroke-width=\"2\"/>
...
\t\t\t\t\t";
        // line 203
        $this->loadTemplate("vfb", "layouts.place", 203)->display($context);
        // line 204
        echo "\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
...
";
        // line 237
        $this->loadTemplate("footer", "layouts.place", 237)->display($context);
    }
    ...
    {
        return array (  308 => 237,  294 => 228,  279 => 218,  263 => 204,  261 => 203,  137 => 82,  133 => 80,  100 => 36,  95 => 35,  89 => 32,  70 => 16,  48 => 3,  45 => 2,  43 => 1,);
    }
}
/* {% include 'header' %}*/
/* */
...
/* 						<div class="route-info__actions">*/
/* 							<div class="route-info__action search-card__action">*/
/* 								<div class="js-add-single-to-plan" data-id="{$ page.id $}" style="{#border-radius: 20px;background: rgba(0, 0, 0, 0.4);position:absolute;margin-top: -120px;display: flex; gap: 10px; align-items: center;#}">*/
