...
/* layouts.routes */
class __TwigTemplate_5f62db4741aeabd6c59ad8731d20bfd24a8afc4d874e4fc42babec6ba9b6f3a4 extends TwigBridge\Twig\Template
{
...
\t\t\t\t\t\t\t\t\t\t\t";
            ...
            if ((isset($context["user"]) ? $context["user"] : null)) {
                // line 204
                echo "\t\t\t\t\t\t\t\t\t\t\t<template v-if=\"checkPurchasedItem(item.id)\">
\t\t\t\t\t\t\t\t\t\t\t\tПриобретено
\t\t\t\t\t\t\t\t\t\t\t</template>
\t\t\t\t\t\t\t\t\t\t\t<template v-else>
\t\t\t\t\t\t\t\t\t\t\t\t<button v-if=\"!!Number(item.field_is_payment_required)\" class=\"rbtn rbtn--text rbtn--size-s\" @click.stop=\"testBuy(item.id)\">{{item.field_price}}₽</button>
\t\t\t\t\t\t\t\t\t\t\t</template>
\t\t\t\t\t\t\t\t\t\t\t";
            } else {
                // line 211
                echo "\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"rbtn rbtn--text rbtn--size-s\" @click.stop=\"openModal('auth')\">{{item.field_price}}₽</button>
\t\t\t\t\t\t\t\t\t\t\t";
            }
            // line 213
            echo "\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t</div>
\t\t\t</div>
\t\t\t<div class=\"modale modale--vue modale--buyobject\" data-modale=\"buyobject\" v-if=\"isBuyObjectModalShowed && buyObjectModalItem\" v-cloak>
\t\t\t\t<div class=\"modale__wrapper\">
\t\t\t\t\t<div class=\"modale__inner\">
\t\t\t\t\t\t<div class=\"modale__closer\"><span class=\"micon-close\" click=\"isBuyObjectModalShowed = false\"></span></div>
\t\t\t\t\t\t<div class=\"modale__main\">
\t\t\t\t\t\t\t<div class=\"modale__title\">Купить</div>
\t\t\t\t\t\t\t<div class=\"modale__content\">
\t\t\t\t\t\t\t\t<div class=\"mbo\">
\t\t\t\t\t\t\t\t\t<div class=\"mbo__block mbo__block--img\">
\t\t\t\t\t\t\t\t\t\t<img :src=\"'/site/data/images/large/' + buyObjectModalItem.field_image\">
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t<div class=\"mbo__block mbo__block--main\">
\t\t\t\t\t\t\t\t\t\t<div class=\"mbo__title\">{{buyObjectModalItem.field_header}}</div>
\t\t\t\t\t\t\t\t\t\t<div class=\"mbo__action\">
\t\t\t\t\t\t\t\t\t\t\t<div class=\"mbo__price\">
\t\t\t\t\t\t\t\t\t\t\t\t{{buyObjectModalItem.field_price}}₽
\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"rbtn rbtn--text rbtn--color-pink\" @click.stop=\"testBuy(buyObjectModalItem.id)\">Купить</button>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
...
";
            // line 395
            $this->loadTemplate("footer", "layouts.routes", 395)->display($context);
            // line 396
            echo "
";
        }
...
/* 										<div class="search-card__action">*/
/* 											{% if user %}*/
/* 											<template v-if="checkPurchasedItem(item.id)">*/
/* 												Приобретено*/
/* 											</template>*/
/* 											<template v-else>*/
/* 												<button v-if="!!Number(item.field_is_payment_required)" class="rbtn rbtn--text rbtn--size-s" @click.stop="testBuy(item.id)">{{item.field_price}}₽</button>*/
/* 											</template>*/
/* 											{% else %}*/
/* 												<button class="rbtn rbtn--text rbtn--size-s" @click.stop="openModal('auth')">{{item.field_price}}₽</button>*/
/* 											{% endif %}*/
/* 										</div>*/
/* 										<div class="search-card__action">*/
/* 											<button class="ibtn" @click.stop="showOnMap(item.field_coords)">*/
