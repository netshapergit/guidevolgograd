...
/* layouts.search_hotels_twig_vue */
class __TwigTemplate_79b3753a70fa8f7e62c9395408d126489069d6c274823ec91ccb17b4523f09b8 extends TwigBridge\Twig\Template
{
...
";
            // line 41
            $this->loadTemplate("header", "layouts.search_hotels_twig_vue", 41)->display($context);
            // line 42
...
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<div class=\"filter filter--hotels-sreda\">
\t\t\t\t\t\t\t\t<div class=\"filter__title\">Доступная среда</div>
\t\t\t\t\t\t\t\t<div class=\"filter-radios\">
\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\" v-for=\"(item,i) in catFilters.hotels.sreda\">
\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" :value=\"item.value\" name=\"cat-filter-hotels-sreda\" v-model=\"selectedCatFilters.hotels.sreda.items\" :id=\"`cat-filter-hotels-sreda-\${i + 1}`\">
\t\t\t\t\t\t\t\t\t\t<label :for=\"`cat-filter-hotels-sreda-\${i + 1}`\">{{item.name}}</label>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t";
            // line 214
            $this->loadTemplate("item_vue", "layouts.search_hotels_twig_vue", 214)->display($context);
            // line 215
...
";
            // line 360
            $this->loadTemplate("footer", "layouts.search_hotels_twig_vue", 360)->display($context);
            // line 361
            echo "
";
        }
    ...
    {
        return "layouts.search_hotels_twig_vue";
    }
    ...
    {
        return array (  524 => 361,  522 => 360,  394 => 235,  389 => 233,  369 => 215,  367 => 214,  354 => 203,  338 => 192,  334 => 191,  263 => 123,  180 => 43,  171 => 42,  169 => 41,  166 => 40,  156 => 37,  153 => 36,  151 => 35,  148 => 34,  145 => 33,  139 => 32,  136 => 31,  133 => 30,  130 => 29,  127 => 28,  122 => 27,  120 => 26,  117 => 25,  114 => 24,  112 => 23,  109 => 22,  103 => 19,  100 => 18,  94 => 17,  91 => 16,  85 => 15,  82 => 14,  79 => 13,  76 => 12,  71 => 11,  68 => 10,  64 => 9,  61 => 8,  58 => 7,  55 => 6,  53 => 5,  50 => 4,  48 => 3,  45 => 2,  43 => 1,);
    }
}
