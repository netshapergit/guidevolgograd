...
/* layouts.route */
class __TwigTemplate_1e2c816cde6d038c9da66a46eb4ded62f901b70f22f52b61a8d717e36fde3e48 extends TwigBridge\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $filters = array("split" => 7, "length" => 17, "slice" => 19, "lower" => 19, "merge" => 20, "escape" => 44, "json_encode" => 44, "raw" => 63, "trim" => 86);
        $functions = array();

        try {
            $this->env->getExtension('sandbox')->checkSecurity(
                array('if', 'set', 'for', 'include'),
                array('split', 'length', 'slice', 'lower', 'merge', 'escape', 'json_encode', 'raw', 'trim'),
                array()
            );
...
\t\t\t\t\t\t\t<div class=\"route-heading__block\">
\t\t\t\t\t\t\t\t<h1 class=\"route__title\">";
            // line 79
...
\t\t\t\t\t\t\t\t";
            ...
            // line 91
            echo "\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<div class=\"route-heading__block route-heading__block--actions\">
\t\t\t\t\t\t\t\t<button class=\"rbtn rbtn--text\" @click.stop=\"setRoute\">Конструктор</button>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t\t
\t\t\t\t\t<div class=\"route-tts-data\" ref=\"ttsData\" style=\"display: none;\">";
            // line 98
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "field_tts_object", array()));
            echo "</div>
...
\t\t\t\t\t\t\t\t";
            // line 159
            echo "\t\t\t\t\t\t\t\t<div class=\"vsearch-hat__tags\">
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"23\" height=\"27\" viewBox=\"0 0 32 37\" fill=\"none\">
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"vcard__main-inner__content\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"vcard__main-hat\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"vcard__main-hat__duration\" v-if=\"item.field_event_duration\">+{{ item.field_event_duration }} ч</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"vcard__main-hat__type\">{{ getItemObjectType(item.layout_id) }}</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"vcard__main-hat__price\" v-if=\"item.field_prices && Number(item.field_prices) > 0\">{{ item.field_prices }}₽</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t<div class=\"vcard-desc\" v-if=\"getItemDescription(item.id)\">
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t<route-card-desc
...
\t\t\t\t\t";
            // line 536
            $this->loadTemplate("vfb", "layouts.route", 536)->display($context);
            // line 537
            echo "\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
...
";
            // line 719
            $this->loadTemplate("footer", "layouts.route", 719)->display($context);
            // line 720
            echo "<script src=\"/site/theme/js/search_routes.js\" type=\"module\"></script>
...
";
    ...
    {
        return array (  738 => 720,  736 => 719,  724 => 709,  720 => 707,  716 => 705,  714 => 704,  560 => 553,  552 => 548,  539 => 537,  537 => 536,  413 => 414,  411 => 307,  328 => 214,  292 => 159,  287 => 151,  282 => 101,  276 => 98,  267 => 91,  263 => 89,  254 => 86,  251 => 85,  247 => 84,  244 => 83,  242 => 82,  239 => 81,  237 => 80,  233 => 79,  214 => 63,  194 => 50,  191 => 49,  189 => 48,  186 => 47,  176 => 44,  173 => 43,  171 => 42,  168 => 41,  165 => 40,  159 => 39,  156 => 38,  153 => 37,  150 => 36,  147 => 35,  142 => 34,  140 => 33,  137 => 32,  134 => 31,  132 => 30,  129 => 29,  123 => 26,  120 => 25,  114 => 24,  111 => 23,  105 => 22,  102 => 21,  99 => 20,  96 => 19,  91 => 18,  88 => 17,  84 => 16,  81 => 15,  78 => 14,  75 => 13,  73 => 12,  70 => 11,  62 => 8,  60 => 7,  57 => 6,  53 => 5,  50 => 4,  48 => 3,  45 => 2,  43 => 1,);
    }
}
...
/* 						<div class="route-heading">*/
/* 							<div class="route-heading__block">*/
/* 								<h1 class="route__title">{$ page.field_header $}</h1>*/
...
/* 					</div>*/
/* 					*/
/* 					<div class="route-tts-data" ref="ttsData" style="display: none;">{$ page.field_tts_object|raw $}</div>*/
/* 					<div class="route-info">*/
/* 						<div class="route__desc">*/
...
/* 							<div class="cont">*/
/* 								{#*/
/* 								<div class="vsearch-hat__actions" style="display: flex; justify-content: flex-end;">*/
/* 									<button class="mbtn" @click.stop="setRoute">В маршрут</button>*/
/* 								</div>*/
/* 								#}*/
...
/* */
/* {% include 'footer' %}*/
/* <script src="/site/theme/js/search_routes.js" type="module"></script>*/
/* */
/* {% endif %}*/
