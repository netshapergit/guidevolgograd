...
/* layouts.search_excursions_twig_vue */
class __TwigTemplate_9b780e6db97a9dde5caf2b449d9710d3d7df392ef5aa86db2b12cb87a7d17451 extends TwigBridge\Twig\Template
{
...
";
            // line 41
            $this->loadTemplate("header", "layouts.search_excursions_twig_vue", 41)->display($context);
            // line 42
...
\t\t\t\t\t\t\t<div class=\"filter filter--excursion-type\">
\t\t\t\t\t\t\t\t<div class=\"filter__title\">Тип</div>
\t\t\t\t\t\t\t\t<div class=\"filter-radios\">
\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\">
\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"\" name=\"cat-filter-excursion-type\" @change=\"selectedCatFilters.excursion.type.items = []\" id=\"cat-filter-excursion-type-0\">
\t\t\t\t\t\t\t\t\t\t<label for=\"cat-filter-excursion-type-0\">Все</label>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\" v-for=\"(item,i) in catFilters.excursion.types\">
\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" :value=\"item.value\" name=\"cat-filter-excursion-type\" @change=\"selectedCatFilters.excursion.type.items = [item.value]\" :id=\"`cat-filter-excursion-type-\${i + 1}`\">
\t\t\t\t\t\t\t\t\t\t<label :for=\"`cat-filter-excursion-type-\${i + 1}`\">{{item.name}}</label>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
...
";
            // line 334
            $this->loadTemplate("footer", "layouts.search_excursions_twig_vue", 334)->display($context);
            // line 335
            echo "
";
        }
    ...
    {
        return "layouts.search_excursions_twig_vue";
    }
    ...
    {
        return array (  496 => 335,  494 => 334,  366 => 209,  361 => 207,  341 => 189,  316 => 165,  300 => 154,  296 => 153,  236 => 96,  180 => 43,  171 => 42,  169 => 41,  166 => 40,  156 => 37,  153 => 36,  151 => 35,  148 => 34,  145 => 33,  139 => 32,  136 => 31,  133 => 30,  130 => 29,  127 => 28,  122 => 27,  120 => 26,  117 => 25,  114 => 24,  112 => 23,  109 => 22,  103 => 19,  100 => 18,  94 => 17,  91 => 16,  85 => 15,  82 => 14,  79 => 13,  76 => 12,  71 => 11,  68 => 10,  64 => 9,  61 => 8,  58 => 7,  55 => 6,  53 => 5,  50 => 4,  48 => 3,  45 => 2,  43 => 1,);
    }
}
