...
/* mobile_search */
class __TwigTemplate_3cd25a6ec0f8bdd39f128a0e46326608b9eab2011719de88f757c172f9f477d1 extends TwigBridge\Twig\Template
{
...
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\">
\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"49\" name=\"mfilter-cat\" v-model=\"searchSelectedCat\" id=\"mfilter-cat-5\">
\t\t\t\t\t\t\t\t\t\t\t<label for=\"mfilter-cat-5\">События</label>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\">
\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"50\" name=\"mfilter-cat\" v-model=\"searchSelectedCat\" id=\"mfilter-cat-7\">
\t\t\t\t\t\t\t\t\t\t\t<label for=\"mfilter-cat-7\">Экскурсии</label>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\">
\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"51\" name=\"mfilter-cat\" v-model=\"searchSelectedCat\" id=\"mfilter-cat-2\">
\t\t\t\t\t\t\t\t\t\t\t<label for=\"mfilter-cat-2\">Рестораны</label>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\">
\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"53\" name=\"mfilter-cat\" v-model=\"searchSelectedCat\" id=\"mfilter-cat-1\">
\t\t\t\t\t\t\t\t\t\t\t<label for=\"mfilter-cat-1\">Отели</label>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\">
\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"52\" name=\"mfilter-cat\" v-model=\"searchSelectedCat\" id=\"mfilter-cat-6\">
