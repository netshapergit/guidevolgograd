...
/* layouts.results */
class __TwigTemplate_79bbc2ab63a0383606bbbf5aa992a22b2fa0b5dca419637d8536f44e11738584 extends TwigBridge\Twig\Template
{
...
\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"\" name=\"filter-cat\" autocomplete=\"off\" v-model=\"searchSelectedCat\" id=\"filter-cat-0\">
\t\t\t\t\t\t\t\t\t\t\t<label for=\"filter-cat-0\">Все</label>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\">
\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"22\" name=\"filter-cat\" autocomplete=\"off\" v-model=\"searchSelectedCat\" id=\"filter-cat-3\">
\t\t\t\t\t\t\t\t\t\t\t<label for=\"filter-cat-3\">Маршруты</label>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\">
\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"24\" name=\"filter-cat\" autocomplete=\"off\" v-model=\"searchSelectedCat\" id=\"filter-cat-4\">
\t\t\t\t\t\t\t\t\t\t\t<label for=\"filter-cat-4\">Места</label>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\">
\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"49\" name=\"filter-cat\" autocomplete=\"off\" v-model=\"searchSelectedCat\" id=\"filter-cat-5\">
\t\t\t\t\t\t\t\t\t\t\t<label for=\"filter-cat-5\">События</label>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\">
\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"50\" name=\"filter-cat\" autocomplete=\"off\" v-model=\"searchSelectedCat\" id=\"filter-cat-7\">
\t\t\t\t\t\t\t\t\t\t\t<label for=\"filter-cat-7\">Экскурсии</label>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\">
\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"51\" name=\"filter-cat\" autocomplete=\"off\" v-model=\"searchSelectedCat\" id=\"filter-cat-2\">
\t\t\t\t\t\t\t\t\t\t\t<label for=\"filter-cat-2\">Рестораны</label>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\">
\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"53\" name=\"filter-cat\" autocomplete=\"off\" v-model=\"searchSelectedCat\" id=\"filter-cat-1\">
\t\t\t\t\t\t\t\t\t\t\t<label for=\"filter-cat-1\">Отели</label>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\">
\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"52\" name=\"filter-cat\" autocomplete=\"off\" v-model=\"searchSelectedCat\" id=\"filter-cat-6\">
...
\t\t\t\t\t\t";
            // line 194
            $this->loadTemplate("item_vue", "layouts.results", 194)->display($context);
            // line 195
...
";
            // line 312
            $this->loadTemplate("footer", "layouts.results", 312)->display($context);
            // line 313
            echo "<script src=\"https://cdn.jsdelivr.net/npm/vue-slider-component@3.1.4/dist/vue-slider-component.umd.min.js\"></script>
<script src=\"/site/theme/js/search_common.js\" type=\"module\"></script>
...
";
    ...
    {
        return array (  452 => 313,  450 => 312,  331 => 195,  329 => 194,  193 => 60,  179 => 48,  171 => 42,  169 => 41,  166 => 40,  156 => 37,  153 => 36,  151 => 35,  148 => 34,  145 => 33,  139 => 32,  136 => 31,  133 => 30,  130 => 29,  127 => 28,  122 => 27,  120 => 26,  117 => 25,  114 => 24,  112 => 23,  109 => 22,  103 => 19,  100 => 18,  94 => 17,  91 => 16,  85 => 15,  82 => 14,  79 => 13,  76 => 12,  71 => 11,  68 => 10,  64 => 9,  61 => 8,  58 => 7,  55 => 6,  53 => 5,  50 => 4,  48 => 3,  45 => 2,  43 => 1,);
    }
}
