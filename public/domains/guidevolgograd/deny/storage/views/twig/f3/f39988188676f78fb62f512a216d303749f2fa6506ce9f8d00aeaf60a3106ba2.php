...
/* layouts.blog_main */
class __TwigTemplate_c4c41561249379d60daf31147c9c52b8473d3c557f3cf1435c51c5212d71f58c extends TwigBridge\Twig\Template
{
    ...
    {
        $tags = array("set" => 1, "for" => 4, "if" => 5, "include" => 80);
        $filters = array("length" => 5, "merge" => 20, "split" => 28, "trim" => 37, "lower" => 37, "slice" => 56, "escape" => 82, "reverse" => 154, "sort" => 154);
        $functions = array();

        try {
            $this->env->getExtension('sandbox')->checkSecurity(
                array('set', 'for', 'if', 'include'),
                array('length', 'merge', 'split', 'trim', 'lower', 'slice', 'escape', 'reverse', 'sort'),
                array()
            );
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["city"]) {
            // line 16
            echo "\t";
            if (($this->getAttribute($context["city"], "layout_id", array()) == 7)) {
                // line 17
                echo "\t\t";
                $context['_parent'] = $context;
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
                    // line 18
                    echo "\t\t\t";
                    if (($this->getAttribute($context["cat"], "layout_id", array()) == 16)) {
                        // line 19
                        echo "\t\t\t\t";
                        $context['_parent'] = $context;
                        $context['_seq'] = twig_ensure_traversable($this->getAttribute($context["cat"], "active_sub_pages", array()));
                        foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
                            // line 20
                            echo "\t\t\t\t\t";
                            $context["items"] = twig_array_merge((isset($context["items"]) ? $context["items"] : null), array(0 => $context["article"]));
                            // line 21
                            echo "\t\t\t\t";
                        }
                        $_parent = $context['_parent'];
...
";
        // line 80
        $this->loadTemplate("header", "layouts.blog_main", 80)->display($context);
        // line 81
        echo "
...
\t\t\t\t";
        // line 115
        $this->loadTemplate("cityswitcher_blog", "layouts.blog_main", 115)->display($context);
        // line 116
        echo "\t\t\t</div>
\t\t\t
\t\t\t";
...
\t\t\t\t";
        // line 154
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_reverse_filter($this->env, twig_sort_filter((isset($context["items"]) ? $context["items"] : null), "created_at")));
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 155
...
";
        // line 176
        $this->loadTemplate("footer", "layouts.blog_main", 176)->display($context);
        // line 177
    ...
    {
        return array (  466 => 177,  464 => 176,  457 => 171,  447 => 167,  440 => 165,  431 => 159,  427 => 158,  422 => 155,  418 => 154,  401 => 142,  390 => 136,  379 => 130,  370 => 123,  367 => 122,  364 => 121,  361 => 120,  358 => 119,  356 => 118,  352 => 116,  350 => 115,  345 => 113,  311 => 82,  308 => 81,  306 => 80,  303 => 79,  301 => 78,  298 => 77,  291 => 75,  288 => 74,  285 => 73,  282 => 72,  279 => 71,  274 => 70,  272 => 69,  269 => 68,  267 => 67,  265 => 66,  262 => 65,  259 => 63,  256 => 62,  250 => 61,  247 => 60,  241 => 59,  238 => 58,  235 => 57,  232 => 56,  227 => 55,  224 => 54,  220 => 53,  217 => 52,  214 => 51,  211 => 50,  209 => 49,  206 => 48,  202 => 46,  200 => 45,  197 => 44,  191 => 43,  188 => 42,  182 => 41,  176 => 40,  173 => 39,  170 => 38,  167 => 37,  162 => 36,  158 => 35,  155 => 34,  152 => 33,  149 => 32,  145 => 31,  142 => 30,  139 => 29,  136 => 28,  134 => 27,  131 => 26,  124 => 24,  118 => 23,  115 => 22,  109 => 21,  106 => 20,  101 => 19,  98 => 18,  93 => 17,  90 => 16,  86 => 15,  83 => 14,  81 => 13,  77 => 11,  69 => 10,  66 => 9,  63 => 8,  60 => 7,  57 => 6,  54 => 5,  49 => 4,  47 => 3,  45 => 2,  43 => 1,);
    }
}
/* {% set homepage = page %}*/
/* {% set index = page %}*/
...
/* {% set items = [] %}*/
/* */
/* {% for city in homepage.active_sub_pages %}*/
/* 	{% if city.layout_id == 7 %}*/
/* 		{% for cat in city.active_sub_pages %}*/
/* 			{% if cat.layout_id == 16 %}*/
/* 				{% for article in cat.active_sub_pages %}*/
...
/* 		<div class="cont">*/
/* 			<div class="blog-posts__wrapper">*/
/* 				{% for item in items|sort('created_at')|reverse %}*/
/* 				<div class="post-card">*/
/* 					<div class="post-card__top">*/
/* 						<div class="post-card__img">*/
/* 							<a href="{$ item.path $}">*/
