...
/* layouts.search_events_twig_vue */
class __TwigTemplate_4f684c9d2f94326ff6f39b14c8f3a95e640bf352d0cfbe1eb675ec8baf0117e8 extends TwigBridge\Twig\Template
{
...
";
            // line 41
            $this->loadTemplate("header", "layouts.search_events_twig_vue", 41)->display($context);
            // line 42
...
\t\t\t\t\t\t\t<div class=\"filter filter--events-type\">
\t\t\t\t\t\t\t\t<div class=\"filter__title\">Тип</div>
\t\t\t\t\t\t\t\t<div class=\"filter-radios\">
\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\">
\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"\" name=\"cat-filter-events-type\" @change=\"selectedCatFilters.events.type.items = []\" id=\"cat-filter-events-type-0\">
\t\t\t\t\t\t\t\t\t\t<label for=\"cat-filter-events-type-0\">Все</label>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\" v-for=\"(item,i) in catFilters.events.types\">
\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" :value=\"item.value\" name=\"cat-filter-events-type\" @change=\"selectedCatFilters.events.type.items = [item.value]\" :id=\"`cat-filter-events-type-\${i + 1}`\">
\t\t\t\t\t\t\t\t\t\t<label :for=\"`cat-filter-events-type-\${i + 1}`\">{{item.name}}</label>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<div class=\"filter filter--events-service\">
\t\t\t\t\t\t\t\t<div class=\"filter__title\">Удобства</div>
\t\t\t\t\t\t\t\t<div class=\"filter-radios\">
\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\" v-for=\"(item,i) in catFilters.events.service\">
\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" :value=\"item.value\" name=\"cat-filter-events-service\" @change=\"selectedCatFilters.events.service.items = [item.value]\" :id=\"`cat-filter-events-service-\${i + 1}`\">
\t\t\t\t\t\t\t\t\t\t<label :for=\"`cat-filter-events-service-\${i + 1}`\">{{item.name}}</label>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
...
";
            // line 342
            $this->loadTemplate("footer", "layouts.search_events_twig_vue", 342)->display($context);
            // line 343
            echo "
";
        }
    ...
    {
        return "layouts.search_events_twig_vue";
    }
    ...
    {
        return array (  504 => 343,  502 => 342,  375 => 218,  370 => 216,  350 => 198,  325 => 174,  309 => 163,  305 => 162,  245 => 105,  180 => 43,  171 => 42,  169 => 41,  166 => 40,  156 => 37,  153 => 36,  151 => 35,  148 => 34,  145 => 33,  139 => 32,  136 => 31,  133 => 30,  130 => 29,  127 => 28,  122 => 27,  120 => 26,  117 => 25,  114 => 24,  112 => 23,  109 => 22,  103 => 19,  100 => 18,  94 => 17,  91 => 16,  85 => 15,  82 => 14,  79 => 13,  76 => 12,  71 => 11,  68 => 10,  64 => 9,  61 => 8,  58 => 7,  55 => 6,  53 => 5,  50 => 4,  48 => 3,  45 => 2,  43 => 1,);
    }
}
