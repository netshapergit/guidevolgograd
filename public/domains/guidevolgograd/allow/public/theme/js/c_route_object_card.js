...
export const routeObjectCard = {
	name: 'routeObjectCard',
	props: {
		item: {
			required: true
		},
	...
	methods: {
		...
		removeItemFromRouteById() {
			this.$emit('remove-item', this.item.objectId)
			//vux.removeItemFromRouteById(this.item.objectId)
		},
		moveItem(item, dayId) {
			this.$emit('move-item', {item, dayId})
		}
	},
	template: `
<div
					...
					<div class="vcard__main-inner">
						...
						<div class="vcard__main-inner__actions">
							<div class="vcard-move">
								<vselect-move :items="myRouteItems" @move-item="(dayId) => moveItem(item, dayId)"></vselect-move>
							</div>
						</div>
					</div>
				</div>
...
{{item}}
		...
		<div class="vcard__right">
			<div class="vcard-remove__button" @click.stop="removeItemFromRouteById">
